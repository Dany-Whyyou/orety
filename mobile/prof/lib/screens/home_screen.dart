              ...
              children: [
                ...
                Expanded(
                  child: _QuickAction(
                    ...
                    label: 'Observations',
                    color: OretyColors.success,
                  ),
                ),
              ],
            ),
            const SizedBox(height: 24),
            const _SectionTitle('Mes affectations'),
            const SizedBox(height: 12),
            const _EmptyAffectationsCard(),
            const SizedBox(height: 24),
...
class _WelcomeCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final prenom = user?.prenom?.isNotEmpty == true ? user!.prenom! : (user?.pseudo ?? 'Professeur');
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Prêt pour vos séances — le ${_formatDate(now)}.',
...
class _EmptyAffectationsCard extends StatelessWidget {
  const _EmptyAffectationsCard();
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Container(
            ...
            child: const Icon(Icons.school_rounded, color: OretyColors.primary, size: 26),
          ),
          const SizedBox(height: 12),
          const Text(
            'Aucune affectation',
          ...
          const Padding(
            ...
            child: Text(
              'L\'administration vous affectera bientôt à des classes et matières.',
